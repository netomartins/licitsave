    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
		  ...
		  <li class="active"><a href="usuarios.php"><i class="fa fa-user-circle"></i> Usuários</a></li>
      ...
      <div class="row">
		...
		<div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">Inserir Novo Usuário</h3>
              <!-- tools box -->
...
<script src="js/form-scripts-user.js?<?php echo filemtime("js/form-scripts-user.js"); ?>"></script>
