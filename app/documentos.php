      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="licitacoes.php"><i class="fa fa-search"></i>Buscar Licitação</a></li>
          </ul>
		  <li ><a href="usuarios.php"><i class="fa fa-user-circle"></i> Usuários</a></li>
		  <li class="active"><a href="documentos.php"><i class="fa fa-book"></i> Documentos da Empresa</a></li>
      ...
      <div class="row">
		...
		<div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">Inserir Novo Documento</h3>
              <!-- tools box -->
		...
		<div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Nome:</label>
                                        <input type="text" class="form-control" id="nomeDoc" name="nomeDoc" placeholder="Informe o Nome" required="">
                                    </div>
                                </div>
								...
								<div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <label>Data Postatem:</label>
                                        <input readonly type="text" class="form-control" id="postagemDoc" name="postagemDoc" required="" value="<?php echo date("d/m/Y"); ?> ">
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="validadeDoc" name="validadeDoc" placeholder="Informe a Validade do Documento" required="">
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <label>Arquivo:</label>
                                        <!-- <input type="text" class="form-control" id="senha" name="senha" placeholder="Informe a Senha" required=""> -->
										<input type="file" name="fileUploadDocEmpresa">
                                    </div>
					...
					<?php
						  ...
						  if(isset($_FILES['fileUploadDocEmpresa']))
							  
					   {
						   
						   $ext2 = strtolower(substr($_FILES['fileUploadDocEmpresa']['name'],-4));
						   
						   //echo strtolower(substr($_FILES['fileUploadDocEmpresa']['name'],-4));
						   //echo '<br>' . $_POST['postagemDoc'];
						   if($ext2 == ".pdf"){
						  date_default_timezone_set("Brazil/East"); //Definindo timezone padrão

						  $ext = strtolower(substr($_FILES['fileUploadDocEmpresa']['name'],-4)); //Pegando extensão do arquivo
						  $new_name = md5(uniqid(time())) . $ext; //Definindo um novo nome para o arquivo
						  $dir = 'uploads/'; //Diretório para uploads

						  move_uploaded_file($_FILES['fileUploadDocEmpresa']['tmp_name'], $dir.$new_name); //Fazer upload do arquivo
						  
						  $nomeDoc = $_POST['nomeDoc'];
						  $postagemDoc = $_POST['postagemDoc'];
						  $validadeDoc = $_POST['validadeDoc'];
							  $sql = "INSERT INTO docs_empresa(nome, data, validade, arquivo) VALUES ('$nomeDoc', '$postagemDoc','$validadeDoc','$new_name')";
							$conn->query($sql);
						   }
						   else {
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
				...
				<tr>
				  ...
				  <td style="text-align: center;"><a href="uploads/<?php echo $arquivo; ?>" target="_blank"><i class="fa fa-download"></i> Baixar</a> | <a href="delDoc.php?id=<?php echo $id; ?>" id="Test"><i class="fa fa-close"></i> Del</a></td>
                </tr>
				<?php } ?>
...
<script src="js/form-scripts-docs.js?<?php echo filemtime("js/form-scripts-docs.js"); ?>"></script>
