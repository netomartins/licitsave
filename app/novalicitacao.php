      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="novalicitacao.php"><i class="fa fa-plus-circle"></i> Nova Licitação</a></li>
    ...
    <section class="content">
      ...
      <div class="row">
		...
		<div class="col-md-12">
					...
					<select id="cad_licita_modalidade" name="cad_licita_modalidade" class="form-control">					  
					   <option value=""> </option>
					  ...
					  <option value="Leilão">Leilão</option>
								...
								<div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="cad_licita_data" name="cad_licita_data" placeholder="Informe a Data" required="">
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="cad_licita_entidade" name="cad_licita_entidade" placeholder="Informe a Entidade" required="">
                                    </div>
